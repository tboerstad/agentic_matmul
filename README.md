...
|---|---|---|---|
| SciPy dgemm | 144.6 | 208.2 | **538.1** |
| NumPy (Accelerate/OpenBLAS) | 216.9 | 252.9 | 483.1 |
| **Mojo (agentic matmul)** | 208.4 | **269.0** | 189.9 |
| Mojo linalg (stdlib) | 182.4 | 153.1 | 104.9 |
...
|---|---|---|---|
| SciPy dgemm | 5.5 | 8.0 | — |
| NumPy (Accelerate/OpenBLAS) | 13.4 | 26.5 | **54.3** |
| **Mojo (agentic matmul)** | **13.9** | 9.3 | **20.7** |
| Mojo linalg (stdlib) | 5.9 | 4.6 | 4.8 |
