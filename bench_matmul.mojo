from gemm import matmul_naive, matmul_tiled, matmul_simd, matmul_parallel, matmul_register_blocked, matmul_packed, matmul_v7
...
fn main() raises:
    ...
    print("=== matmul benchmark: naive vs tiled vs simd vs parallel vs register-blocked vs packed vs v7 (Qwen 2.5 VL 3B shapes) ===\n")
    ...
    var r_v7_1 = std.benchmark.run[bench_decode_v7]()
    var s_v7_1 = r_v7_1.mean("s")
    print(
        "  v7    :",
        r_v7_1.mean("ms"),
        "ms |",
        gflops(M1, N1, K1, s_v7_1),
        "GFLOPS",
    )
    ...
    print("  speedup (naive/v7)       :", s_naive_1 / s_v7_1, "x")
    print("  speedup (packed/v7)      :", s_packed_1 / s_v7_1, "x\n")
    ...
    var r_v7_2 = std.benchmark.run[bench_prefill_v7]()
    var s_v7_2 = r_v7_2.mean("s")
    print(
        "  v7    :",
        r_v7_2.mean("ms"),
        "ms |",
        gflops(M2, N2, K2, s_v7_2),
        "GFLOPS",
    )
    ...
    print("  speedup (naive/v7)       :", s_naive_2 / s_v7_2, "x")
    print("  speedup (packed/v7)      :", s_packed_2 / s_v7_2, "x\n")
