...
fn main() raises:
    ...
    print("=== matmul benchmark: naive vs tiled vs simd vs parallel vs register-blocked vs packed vs b_packed (Qwen 2.5 VL 3B shapes) ===\n")
    ...
    @parameter
    fn bench_decode_b_packed():
        var a = Matrix(M1, K1)
        var b = Matrix(K1, N1)
        var c = Matrix(M1, N1)
        fill(a, 17)
        fill(b, 13)
        matmul_b_packed(c, a, b)
    ...
    var r_bpacked_1 = std.benchmark.run[bench_decode_b_packed]()
    var s_bpacked_1 = r_bpacked_1.mean("s")
    print(
        "  b_packed:",
        r_bpacked_1.mean("ms"),
        "ms |",
        gflops(M1, N1, K1, s_bpacked_1),
        "GFLOPS",
    )
    ...
    print("  speedup (naive/b_packed) :", s_naive_1 / s_bpacked_1, "x")
    print("  speedup (packed/b_packed):", s_packed_1 / s_bpacked_1, "x\n")
    ...
    var r_bpacked_2 = std.benchmark.run[bench_prefill_b_packed]()
    var s_bpacked_2 = r_bpacked_2.mean("s")
    print(
        "  b_packed:",
        r_bpacked_2.mean("ms"),
        "ms |",
        gflops(M2, N2, K2, s_bpacked_2),
        "GFLOPS",
    )
    ...
    print("  speedup (naive/b_packed) :", s_naive_2 / s_bpacked_2, "x")
    print("  speedup (packed/b_packed):", s_packed_2 / s_bpacked_2, "x\n")
    ...
    r_packed_2.print()
    print("\n1x11008x2048 b_packed:")
    r_bpacked_1.print()
    print("\n96x11008x2048 b_packed:")
    r_bpacked_2.print()
